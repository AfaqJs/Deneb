...
const HomePageSlider = (props) => {
  return (
    <div className=' '>
      <div className={` flex m-h-s flex-row  items-center w-[550px] my-[2rem] mx-auto ss:w-[550px] ssms:w-[610px] sm:w-[736px] smml:w-[920px]   smml:flex-nowrap flex-wrap lg:px-0 px-[15px] `}>
        <div className="header-text z-[1] mr-auto xs:w-[550px] xfm:w-[300px]">
          ...
          <p className="w-[400px] text-[#7a808d] mt-[7px] text-[15px]">
            Nulla id euismod massa. Donec accumsan <br className="xs:hidden"/> semper lacus, vestibulum
            gravida ante sed <br className="xs:hidden"/> eu lacus et diam lacinia.
          </p>
          <button className=" mt-[25px] py-[10px] px-[25px] rounded-[20px] text-[14px] bg-[#feb000] text-white font-medium">
            HIRE ME
          </button>
        </div>
        <div className=" z-[1] mt-[1rem] smml:mt-[0] xs:w-[550px] xfm:w-[300px]">

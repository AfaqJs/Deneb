      ...
      <form>
        <div className="  flex  justify-between flex-wrap">
          <input
            ...
            required
            className="px-[30px] w-[47%] h-[35px] circle rounded-[25px] border-none focus:outline-none"
          />
          <input
            type="text"
        ...
        <div className="  flex  justify-between flex-wrap mt-[1.8rem]">
          <input
            ...
            className="px-[30px] w-[47%] h-[35px] circle rounded-[25px] border-none focus:outline-none"
          />
          <select className="px-[30px] w-[47%] h-[35px] circle rounded-[25px] border-none focus:outline-none">
        ...
        <textarea name="" id="" cols="74" rows="5" placeholder="Message" className="circle rounded-[20px]  p-[20px] focus:outline-none w-[100%]"></textarea>
        </div>

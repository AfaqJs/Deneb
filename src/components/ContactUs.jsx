        ...
        <div className=" flex justify-between items-center flex-wrap ">
          ...
          <div className=" w-[400px mx-0 ss:mx-auto">
            <div className="contact-text smml:px-0 px-[15px]">
                <h2 className=" smml:text-[45px] text-[32px] font-semibold md:mt-0 mt-[2rem] ">Get In Touch With Us</h2>
            ...
            <div className="  contactForm mt-[2rem] text-[14px] smml:px-0 px-[15px] ss:pr-[15px]">
              <div className=" flex justify-between smml:w-[100%]  ss:-[100%]">
              <input type="text" placeholder='First Name' required className='smml:px-[30px] ss:px-[40px] py-[10px] px-[15px] circle rounded-[25px] border-none focus:outline-none'/>
              <input type="text" placeholder='Last Name' required className=' ss:px-[40px] smml:px-[30px] smml:py-[10px] px-[15px]  circle rounded-[25px] border-none focus:outline-none'/>
              </div>
              <div className=" flex justify-between mt-[1.2rem] smml:w-[100%]">
              <input type="email" placeholder='Email Address' required className=' ss:px-[40px] smml:px-[30px] py-[10px] px-[15px] circle rounded-[25px] border-none focus:outline-none'/>
              <input type="tel" placeholder='Phone No' required className='smml:px-[30px] py-[10px] px-[15px] circle ss:px-[40px] rounded-[25px] border-none focus:outline-none'/>
              </div>

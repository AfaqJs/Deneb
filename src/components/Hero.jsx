...
const Hero = () => {
  ...
  return (
    ...
    <section className=' relative z-[100]  pt-[2rem]'>
        <nav  className=' nav-bar smml:px-[2rem] md:px-0 flex items-center flex-wrap smml:w-[942px] lg:w-[1100px]  mx-auto xs:w-[522px] ss:w-[550px] ssms:w-[610px] sm:w-[700px]  '>
            <img src={logo} alt=""  className=' mr-auto smml:w-[12%] w-[24%]sm:w-[11px]'/>

  ...
  return (
    <section className=" smml:mt-[6rem] max-w-[1100px] mx-auto">
      <div className=" flex smml:justify-between ssms:justify-center flex-wrap smml:px-[15px] lg:px-0">
        <div className=" w-[52%] smml:w-[44%] smml:mr-[1rem] smml:mt-[6rem] mt-[4rem] text-justify smml:text-justify ssms:text-center">
          <h2 className=" md:text-[42px] text-[32px] font-semibold smml:leading-[54px]  ssms:w-[100%] w-[23rem] ml-[20px] ssms:ml-0  ">
            Over 500+ Completed work & Still Counting
          </h2>
          <p className="  text-[15px] py-[30px] smml:max-w-[500px] text-[#7a808d]  ml-[20px] md:ml-0 w-[26rem] ssms:w-[100%] ssms:ml-0">
            Orci varius natoque penatibus et magnis dis parturient montes,
            nascetur ridiculus mus. Phasellus at orci non risus luctus commodo.
            Ut nibh tellus, faucibus nec gravida.
          </p>
          <p className=" pb-[25px] text-[15px] text-[#7a808d] smml:max-w-[500px] ml-[20px] md:ml-0 w-[26rem] ssms:w-[100%] ssms:ml-0">
            Duis quis ipsum leo. Praesent vitae tellus ac ante porta mattis vel
            non ex. Quisque a finibus justo.
          </p>
        </div>

        <div className=" flex mx-auto smml:mx-0 smml:ml-[1rem]  ssms:pr-0 pr-[15px] w-[500px] smml:w-[460px]  lg:w-[550px] smml:justify-end justify-center">
          ...
          <div className=" flex flex-col mt-[2rem] smml:justify-end">
